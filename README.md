...
```javascript
pkg2standalone = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/namespace-pkg2standalone@v0.4.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/namespace-pkg2standalone/actions/workflows/test.yml/badge.svg?branch=v0.4.0
[test-url]: https://github.com/stdlib-js/namespace-pkg2standalone/actions/workflows/test.yml?query=branch:v0.4.0
